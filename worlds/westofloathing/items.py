...
item_table: Dict[str, WOLItemData] = {
    ...
    "Potted Meat x2": WOLItemData(ItemClassification.filler, {"Consumables", "Food"}),
    ...
    "\"Cotton Candy\" x3": WOLItemData(ItemClassification.filler, {"Consumables", "Food"}),
    ...
    "Tripe Pie x2": WOLItemData(ItemClassification.filler, {"Consumables", "Food"}),
    "Decent Whiskey x2": WOLItemData(ItemClassification.filler, {"Consumables", "Booze"}),
    "Patent Emetic x5": WOLItemData(ItemClassification.filler, {"Consumables", "Combat"}),
    ...
    "Snake Chunks": WOLItemData(ItemClassification.useful, {"Consumables", "Combat"}),
    ...
    "El Vibrato Scraps x10": WOLItemData(ItemClassification.filler, {"Quest Items"}),
    ...
    "Jar Of Peanut Butter x2": WOLItemData(ItemClassification.filler, {"Consumables", "Food"}),
    "Goat Steak x3": WOLItemData(ItemClassification.filler, {"Consumables", "Food"}),
    "Moon Bits x3": WOLItemData(ItemClassification.useful, {"Miscellany"}),
    "Fancy Coffee": WOLItemData(ItemClassification.filler, {"Consumables", "Potions"}),
    "Spider Pie x2": WOLItemData(ItemClassification.filler, {"Consumables", "Food"}, is_dlc=True),
    "Box Of Science Doohickeys": WOLItemData(ItemClassification.useful, {"Quest Items"}, is_dlc=True),
