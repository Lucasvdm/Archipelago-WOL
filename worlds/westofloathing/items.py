...
item_table: Dict[str, WOLItemData] = {
    ...
    "Gold Skull": WOLItemData(ItemClassification.filler, {"Miscellany"}, 2, is_dlc=True),
    "Stock Certificate": WOLItemData(ItemClassification.filler, {"Miscellany"}, 2, is_dlc=True),
